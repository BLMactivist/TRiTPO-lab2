...
Люди младшей возрастной категории (14-18) лет, обладающие минимальной технической грамотностью: умением взаимодействовать с компьютером/телевизором.
...
**Функция.** Вход в приложение без создания собственного профиля	Приложение должно предоставить пользователю возможность войти в приложение анонимно
Регистрация нового пользователя	Приложение должно запросить у пользователя ввести имя для создания учётной записи. Пользователь должен либо ввести имя, либо отменить действие	**Требования.**
